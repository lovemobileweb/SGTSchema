@ModelType SchemaOnlyModel
@Code
    ViewData("Title") = "Edit Schema Only"
    Dim FuncName = "Save"
    If Model Is Nothing Then
        FuncName = "Create"
        ViewData("Title") = "Create Schema Only"
    ElseIf Model.ID = 0 Then
        FuncName = "Create"
        ViewData("Title") = "Create Schema"
    End If
...
<section class="content">
    @Using Html.BeginForm(FuncName, "SchemaOnly", FormMethod.Post, New With {.class = "form-horizontal", .role = "form", .enctype = "multipart/form-data"})
    ...
    @<text>
        ...
        <div class="form-group">
            @Html.LabelFor(Function(m) m.cServiceCat, New With {.class = "col-md-5 control-label"})
            <div class="col-md-7">
        ...
        <div class="form-group">
            @Html.Label("", New With {.class = "col-md-2 control-label"})
            @Html.LabelFor(Function(m) m.cCity1, New With {.class = "col-md-5 control-label"})
            @Html.LabelFor(Function(m) m.cCity2, New With {.class = "col-md-5 control-label"})
        </div>
        <div class="form-group">
            @Html.Label("Areas Served", New With {.class = "col-md-2 control-label"})
            <div class="col-md-5">
        ...
        <div class="form-group">
            @Html.Label("", New With {.class = "col-md-2 control-label"})
            @Html.LabelFor(Function(m) m.cCity3, New With {.class = "col-md-5 control-label"})
            @Html.LabelFor(Function(m) m.cCity4, New With {.class = "col-md-5 control-label"})
        </div>
        <div class="form-group">
            @Html.Label("Areas Served", New With {.class = "col-md-2 control-label"})
            <div class="col-md-5">
        ...
        <div class="form-group">
            @Html.Label("", New With {.class = "col-md-2 control-label"})
            @Html.LabelFor(Function(m) m.cCity5, New With {.class = "col-md-5 control-label"})
            @Html.LabelFor(Function(m) m.cCity6, New With {.class = "col-md-5 control-label"})
        </div>
        <div class="form-group">
            @Html.Label("Areas Served", New With {.class = "col-md-2 control-label"})
            <div class="col-md-5">
        ...
        <div class="form-group">
            @Html.Label("", New With {.class = "col-md-2 control-label"})
            @Html.LabelFor(Function(m) m.cCity7, New With {.class = "col-md-5 control-label"})
            @Html.LabelFor(Function(m) m.cCity8, New With {.class = "col-md-5 control-label"})
        </div>
        <div class="form-group">
            @Html.Label("Areas Served", New With {.class = "col-md-2 control-label"})
            <div class="col-md-5">
        ...
        <div class="form-group">
            @Html.Label("", New With {.class = "col-md-2 control-label"})
            @Html.LabelFor(Function(m) m.cCity9, New With {.class = "col-md-5 control-label"})
            @Html.LabelFor(Function(m) m.cCity10, New With {.class = "col-md-5 control-label"})
        </div>
        <div class="form-group">
            @Html.Label("Areas Served", New With {.class = "col-md-2 control-label"})
            <div class="col-md-5">
            ...
            <div class="col-md-5">
                @Html.TextBoxFor(Function(m) m.cCity10, New With {.class = "form-control"})
                @Html.ValidationMessageFor(Function(m) m.cCity10, "", New With {.class = "text-danger"})
            </div>
        </div>
